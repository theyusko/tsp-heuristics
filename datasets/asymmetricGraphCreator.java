 ...
 * @author Ahmet Batu
 */
public class asymmetricGraphCreator 
{
    ...
    public asymmetricGraphCreator(int nodeNumber, int arcNumber, int spaceDimension)
    {
        ...
        generteAsymmetricGraph(nodeLocations, distances, tempCycle);
        }
    }
    ...
    private void generteAsymmetricGraph(ArrayList<ArrayList<Integer>> nodeLocationsInputArray, 
                                                        ArrayList<ArrayList<Integer>> distancesInputArray,
                                                        ArrayList<Integer> cycleInputArray)
    { 
        for(int i = 0 ; i < nodeNumber ; i++) 
